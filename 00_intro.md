...
Мы думаем, что создаем систему для своих собственных целей. Мы верим, что создаем ее по своему образу и подобию... Но компьютер на самом деле не похож на нас. Он является проекцией очень узкой части нас самих: той части, которая отвечает за логику, порядок, правила и ясность.
...
Если перед компьютером стоит обычная, хорошо понятная задача, например, проверка электронной почты или использование калькулятора, вы можете открыть соответствующее ((приложение)) и приступить к работе. Но для уникальных или неопределенных задач часто не существует подходящего приложения.

Именно здесь на помощь может прийти ((программирование)). _Программирование_ - это процесс создания _программы_ - набора точных инструкций, указывающих компьютеру, что делать. Поскольку компьютеры — это тупые и педантичные существа, программирование в основе своей является утомительным и разочаровывающим занятием.

{{index [programming, "joy of"], speed}}

К счастью, если вы сможете смириться с этим фактом, и, возможно, вам даже понравится строгость мышления в терминах, понятных тупым машинам, — программирование может стать увлекательным и полезным занятием. Оно позволяет вам делать за секунды то, что вручную заняло бы _вечность_. Это способ заставить ваш компьютер выполнять задачи, которые он раньше не мог делать. Более того, программирование превращается в увлекательную игру, где нужно решать головоломки и мыслить абстрактно.

В основном программирование осуществляется с помощью ((языков программирования)). _Язык программирования_ — это искусственно созданный язык, используемый для передачи инструкций компьютеру. Интересно, что самый эффективный способ общения с компьютером, который мы нашли, в значительной степени заимствует то, как мы общаемся друг с другом. Как и человеческие языки, компьютерные языки позволяют комбинировать слова и фразы по-новому, что позволяет выражать всё новые и новые понятия.

{{index [JavaScript, "availability of"], "casual computing"}}

В свое время интерфейсы, основанные на языках, такие как BASIC и командная строка DOS в 1980-х и 1990-х годах, были основным способом взаимодействия с компьютерами. Для повседневного использования компьютеров их в значительной степени заменили визуальные интерфейсы, которые проще в освоении, но предоставляют меньше свободы. Но если вы знаете, где искать, языки все еще существуют. Один из них, _JavaScript_, встроен в каждый современный веб-((браузер)) и поэтому доступен почти на каждом устройстве.

{{indexsee "web browser", browser}}

Эта книга постарается познакомить вас с этим языком настолько, чтобы вы могли использовать его для выполнения полезных и интересных задач.

## О программировании

{{index [programming, "difficulty of"]}}

Помимо объяснения JavaScript, я познакомлю вас с основными принципами программирования. Оказывается, программирование — это сложно. Фундаментальные правила просты и понятны, но программы, построенные на основе этих правил, часто становятся настолько сложными, что порождают свои собственные правила и сложности. В каком-то смысле вы строите свой собственный лабиринт, и в нем легко заблудиться.
...
Всё зависит от ваших усилий. Если вам трудно следовать книге, не делайте поспешных выводов о своих способностях. С вами всё в порядке — просто нужно продолжать работать. Сделайте перерыв, перечитайте материал и убедитесь, что вы внимательно изучили и поняли примеры программ и ((упражнения)). Обучение — это тяжелый труд, но всё, что вы усвоите, останется с вами и облегчит дальнейшее обучение.

{{quote {author: "Ursula K. Le Guin", title: "The Left Hand of Darkness"}

{{index "Le Guin, Ursula K."}}

Когда действия становятся бесполезными, собирайте информацию; когда информация становится бесполезной, спите.

quote}}

{{index [program, "nature of"], data}}

Программа — это множество вещей. Это текст, набранный программистом, это направляющая сила, которая заставляет компьютер выполнять свои задачи, это данные в памяти компьютера, и в то же время она управляет действиями, выполняемыми с этой памятью. Аналогии, которые пытаются сравнить программы с привычными объектами, обычно оказываются неудачными. Поверхностно подходящая аналогия - это сравнение программы с механизмом — множество отдельных частей взаимодействуют друг с другом, и чтобы заставить всю систему работать, мы должны учитывать, как эти части связаны между собой и способствуют функционированию целого.
...
Важно отметить, что JavaScript практически не имеет ничего общего с языком программирования Java. Схожее название было вдохновлено скорее маркетинговыми соображениями, чем здравым смыслом. Когда JavaScript только появлялся, язык Java активно продвигался и набирал популярность. Кто-то решил, что это хорошая идея — попытаться воспользоваться этим успехом. Теперь мы застряли с этим названием.

{{index ECMAScript, compatibility}}

После того как JavaScript вышел за пределы Netscape, был написан ((стандарт))ный документ, описывающий, как должен работать язык JavaScript, чтобы различные программные продукты, заявляющие о поддержке JavaScript, были уверены, что они действительно предоставляют один и тот же язык. Этот документ называется стандартом ECMAScript, по названию организации Ecma International, которая занималась стандартизацией. На практике термины ECMAScript и JavaScript могут использоваться взаимозаменяемо — это два названия одного и того же языка.

{{index [JavaScript, "weaknesses of"], debugging}}

Есть те, кто будет говорить _ужасные_ вещи о JavaScript. Многое из этого правда. Когда мне впервые потребовалось написать что-то на JavaScript, я быстро начал его презирать. Он принимал почти всё, что я вводил, но интерпретировал это совершенно не так, как я задумывал. Конечно, это во многом было связано с тем, что я понятия не имел, что делаю, но здесь кроется реальная проблема: JavaScript невероятно либерален в том, что он позволяет. Идея, стоящая за таким дизайном, заключалась в том, что это сделает программирование на JavaScript проще для новичков. На самом деле, это в основном затрудняет поиск проблем в ваших программах, потому что система не будет указывать вам на них.
...
Существовало несколько версий JavaScript. ECMAScript версии 3 был широко поддерживаемым во время восхождения JavaScript к доминированию, примерно с 2000 по 2010 год. В это время велась работа над амбициозной версией 4, в которой планировалось внести ряд радикальных улучшений и расширений в язык. Оказалось, что изменение живого, широко используемого языка таким радикальным образом является политически сложным, и работа над версией 4 была прекращена в 2008 году. Гораздо менее амбициозная версия 5, которая внесла только некоторые неоспоримые улучшения, вышла в 2009 году. В 2015 году вышла версия 6, крупное обновление, включающее некоторые идеи, запланированные для версии 4. С тех пор новые, небольшие обновления выходят каждый год.

Тот факт, что JavaScript развивается, означает, что браузеры должны постоянно успевать за ним. Если вы используете старый браузер, он может поддерживать не все функции. Разработчики языка стараются не вносить никаких изменений, которые могли бы нарушить работу существующих программ, поэтому новые браузеры по-прежнему могут запускать старые программы. В этой книге я использую версию JavaScript 2024 года.
...
Часть книги, посвящённая языку, начинается с четырёх глав, которые знакомят с базовой структурой JavaScript. В них обсуждаются [структуры управления](program_structure) (такие как слово `while`, которое вы видели в этом введении), [функции](functions) (создание собственных строительных блоков) и [структуры данных](data). После этого вы сможете писать базовые программы. Затем главы [?](higher_order) и [?](object) представляют техники использования функций и объектов для написания более _абстрактного_ кода и контроля сложности.
